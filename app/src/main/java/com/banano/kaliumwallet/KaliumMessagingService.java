...
import com.banano.kaliumwallet.broadcastreceiver.CancelNotificationReceiver;
...
public class KaliumMessagingService extends FirebaseMessagingService {
    ...
    private static final String NOTIFICATION_CHANNEL_ID = "kalium_notification_channel";
